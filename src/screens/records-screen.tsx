...
const styles = StyleSheet.create({
  ...
  kicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 11, letterSpacing: 2.5 },
  title: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 31, letterSpacing: 2 },
  description: { maxWidth: 560, marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15, lineHeight: 23 },
  ...
  clearButtonText: { color: '#E4A89A', fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  loadMoreText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  filterButtonText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  compareTitle: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 17 },
  compareHint: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  compareClearText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  compareError: { marginTop: spacing.x3, color: '#E4A89A', fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  compareFields: { marginTop: spacing.x3, borderTopWidth: 1, borderColor: palette.hairline },
  compareEmpty: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  compareRow: { flexDirection: 'row', gap: spacing.x3, borderBottomWidth: 1, borderColor: palette.hairline, paddingVertical: spacing.x2 },
  compareLabel: { width: 74, color: palette.patina, fontFamily: fontFamilies.body, fontSize: 12 },
  compareValueColumn: { flex: 1, gap: spacing.x1 },
  compareOld: { color: '#C9A58E', fontFamily: fontFamilies.body, fontSize: 13 },
  compareNew: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  readOnlyTitle: { color: '#E4A89A', fontFamily: fontFamilies.body, fontSize: 15, fontWeight: '600' },
  readOnlyText: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  emptyTitle: { marginTop: spacing.x3, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 21 },
  emptyText: { maxWidth: 380, marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22, textAlign: 'center' },
  list: { marginTop: spacing.x6, gap: spacing.x4 },
  group: { gap: spacing.x3 },
  groupLabel: { color: palette.brass, fontFamily: fontFamilies.display, fontSize: 17, letterSpacing: 1 },
  ...
  moduleGlyph: { fontFamily: fontFamilies.display, fontSize: 17 },
  ...
  moduleName: { flex: 1, color: palette.brass, fontFamily: fontFamilies.body, fontSize: 12 },
  date: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11 },
  ...
  compareToggleText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11 },
  compareToggleTextActive: { color: palette.paleBrass },
  cardTitle: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 19 },
  cardSummary: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  favoriteButtonText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  feedbackButtonText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  feedbackTitle: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 17 },
  feedbackCount: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 12 },
  feedbackHint: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 18 },
  feedbackEmpty: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  feedbackStatus: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  feedbackDate: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 12 },
  feedbackUpdated: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11 },
  feedbackEdit: { minHeight: layout.minTouch, marginLeft: 'auto', justifyContent: 'center', paddingHorizontal: spacing.x3 },
  feedbackEditText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12 },
  feedbackDelete: { minHeight: layout.minTouch, marginLeft: 'auto', justifyContent: 'center', paddingHorizontal: spacing.x3 },
  feedbackDeleteText: { color: '#C89283', fontFamily: fontFamilies.body, fontSize: 12 },
  feedbackNote: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  feedbackLinks: { marginTop: spacing.x1, color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11, lineHeight: 17 },
  feedbackForm: { marginTop: spacing.x4, borderTopWidth: 1, borderColor: palette.hairline, paddingTop: spacing.x3 },
  feedbackFormLabel: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13 },
  feedbackLinkHint: { marginTop: spacing.x2, color: palette.patina, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 17 },
  ...
  feedbackLinkOptionTitle: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  feedbackLinkOptionTitleActive: { color: palette.paleBrass },
  feedbackLinkOptionSummary: { marginTop: spacing.x1, color: palette.patina, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 17 },
  ...
  feedbackEvidenceLabel: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  feedbackEvidenceText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 18 },
  ...
  statusOptionText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  statusOptionTextActive: { color: palette.paleBrass },
  feedbackInput: { minHeight: layout.minTouch, marginTop: spacing.x2, borderWidth: 1, borderColor: palette.hairline, borderRadius: radii.input, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 14, paddingHorizontal: spacing.x3, paddingVertical: spacing.x2 },
  feedbackNoteInput: { minHeight: 86, paddingTop: spacing.x3 },
  feedbackError: { marginTop: spacing.x2, color: '#E4A89A', fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 18 },
  ...
  deleteButtonText: { color: '#E4A89A', fontFamily: fontFamilies.body, fontSize: 13 },
