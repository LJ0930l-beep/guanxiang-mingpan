...
const styles = StyleSheet.create({
  ...
  backText: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 14, letterSpacing: 1 },
  ...
  kicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 12, letterSpacing: 3 },
  ...
  description: { maxWidth: 460, marginTop: spacing.x4, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 16, lineHeight: 26, textAlign: 'center' },
  ...
  actionText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 15 },
