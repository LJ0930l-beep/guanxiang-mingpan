...
const styles = StyleSheet.create({
  ...
  brandName: { color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 19, letterSpacing: 2 },
  brandMeta: { marginTop: 2, color: palette.brass, fontFamily: fontFamilies.data, fontSize: 10, letterSpacing: 1.5 },
  profileChip: {
    maxWidth: 138,
  ...
  profileChipText: { flexShrink: 1, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  eyebrow: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 13, letterSpacing: 3 },
  heroTitle: {
  ...
  factItem: { flex: 1 },
  factValue: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 17, letterSpacing: 1 },
  factLabel: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  sectionKicker: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 12, letterSpacing: 2.5 },
  sectionTitle: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 24, letterSpacing: 1.5 },
  sectionMeta: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  moduleArrow: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 17 },
  moduleClassicalName: { marginTop: spacing.x5, color: palette.brass, fontFamily: fontFamilies.body, fontSize: 11, letterSpacing: 1.8 },
  moduleTitle: { marginTop: spacing.x1, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 21, letterSpacing: 1 },
  moduleDescription: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22 },
  moduleFooter: { marginTop: 'auto', paddingTop: spacing.x5, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  moduleFooterText: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  profileDescription: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22 },
  profileAction: {
    minHeight: layout.minTouch,
    alignItems: 'center',
  ...
  profileActionText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 14 },
