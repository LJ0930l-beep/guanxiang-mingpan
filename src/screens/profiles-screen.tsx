...
const styles = StyleSheet.create({
  ...
  description: { marginTop: spacing.x3, maxWidth: 520, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15, lineHeight: 23 },
  ...
  addButtonText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  formHint: { marginTop: spacing.x2, marginBottom: spacing.x5, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22 },
  label: { marginTop: spacing.x4, marginBottom: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 15 },
  input: { minHeight: 48, borderWidth: 1, borderColor: palette.hairlineStrong, borderRadius: radii.input, backgroundColor: palette.obsidian, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 17, paddingHorizontal: spacing.x4 },
  cityStatus: { marginTop: spacing.x2, fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 18 },
  ...
  citySuggestionText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  chipText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  segmentText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  switchCopy: { flex: 1 },
  switchLabel: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 15 },
  switchHint: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 19 },
  error: { marginTop: spacing.x4, color: '#D88978', fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 20 },
  globalError: { marginTop: spacing.x4, color: '#D88978', fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 20 },
  ...
  listCount: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 14 },
  ...
  emptyTitle: { marginTop: spacing.x3, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 19 },
  emptyText: { maxWidth: 360, marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22, textAlign: 'center' },
  ...
  profileMonogramText: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 19 },
  profileCopy: { flex: 1 },
  profileNameRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.x2 },
  profileName: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 17, fontWeight: '600' },
  relationship: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 12 },
  profileMeta: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  profileActionText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
