...
const styles = StyleSheet.create({
  ...
  countryCodeText: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 16 },
  input: {
    minHeight: 48,
    borderWidth: 1,
    borderColor: palette.hairlineStrong,
  ...
  codeButtonText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 15 },
  helperText: {
    marginTop: spacing.x3,
  ...
  dividerText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14 },
