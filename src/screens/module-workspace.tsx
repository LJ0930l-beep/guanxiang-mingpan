...
function BaziResult({ result }: { result: BaziChartView }) {
  ...
  return (
      ...
      <View style={styles.resultHeading}><View pointerEvents="none" style={styles.ambientAnchor}><AmbientRing size={132} /></View><View><Text style={styles.resultEyebrow}>四柱命盘{result.completeness === 'partial' ? ' · 部分盘' : ''}</Text><Text style={styles.resultTitle}>{result.dayMaster}日主</Text></View><Text style={styles.engineTag}>{result.engineVersion}</Text></View>
  ...
  return (
    <WorkspacePanel>
      <View style={styles.coinHeading}>
        <View pointerEvents="none" style={styles.ambientAnchor}><AmbientRing size={120} duration={30000} /></View>
...
const styles = StyleSheet.create({
  ...
  heroKicker: { fontFamily: fontFamilies.data, fontSize: 12, letterSpacing: 2.5, textTransform: 'uppercase' },
  ...
  heroDescription: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 17, lineHeight: 27, textAlign: 'center' },
  ...
  localBadgeText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  profileSealText: { fontFamily: fontFamilies.display, fontSize: 18 },
  profileBannerCopy: { flex: 1, minWidth: 0 },
  profileLabel: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 11, letterSpacing: 1.8 },
  profileName: { marginTop: 2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 17, fontWeight: '600' },
  profileMeta: { marginTop: 3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  switchProfile: { minWidth: 60, minHeight: layout.minTouch, alignItems: 'center', justifyContent: 'center' },
  switchProfileText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  panelDescription: { maxWidth: 480, marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15, lineHeight: 24, textAlign: 'center' },
  ...
  workspaceKicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 11, letterSpacing: 2.2 },
  workspaceTitle: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 23, letterSpacing: 1 },
  workspaceMeta: { flexShrink: 0, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 12 },
  workspaceDescription: { marginTop: spacing.x4, marginBottom: spacing.x5, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15, lineHeight: 24 },
  fieldBlock: { marginTop: spacing.x5 },
  fieldLabel: { marginTop: spacing.x4, marginBottom: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 15 },
  fieldHint: { marginTop: spacing.x2, marginBottom: spacing.x4, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  segmentText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15 },
  segmentTextActive: { color: palette.ricePaper },
  textInput: { minHeight: 48, borderWidth: 1, borderColor: palette.hairlineStrong, borderRadius: radii.input, backgroundColor: palette.obsidian, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 17, paddingHorizontal: spacing.x4, paddingVertical: spacing.x3 },
  ...
  choiceChipText: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14 },
  ...
  errorText: { flex: 1, color: '#DCA091', fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 21 },
  savedNotice: { marginTop: spacing.x4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.x2 },
  savedText: { color: palette.patina, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  loadingText: { marginTop: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20, textAlign: 'center' },
  ...
  resultEyebrow: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 11, letterSpacing: 2 },
  resultTitle: { marginTop: spacing.x1, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 27, letterSpacing: 1 },
  engineTag: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11 },
  ...
  pillarLabel: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12, letterSpacing: 2 },
  ...
  pillarTenGod: { marginTop: spacing.x2, color: palette.brass, fontFamily: fontFamilies.body, fontSize: 13 },
  pillarDetail: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 17, textAlign: 'center' },
  ...
  dayunGanZhi: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 19 },
  dayunMeta: { marginTop: 2, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11 },
  dayunLiunian: { marginTop: spacing.x3, borderTopWidth: 1, borderColor: palette.hairline, paddingTop: spacing.x3 },
  dayunLiunianTitle: { color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 17 },
  evidenceLabel: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 13 },
  evidenceValue: { flex: 1, color: palette.ricePaper, fontFamily: fontFamilies.data, fontSize: 13 },
  ...
  evidencePanelKicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 10, letterSpacing: 1.8 },
  evidencePanelTitle: { marginTop: 3, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 17 },
  evidencePanelAction: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  ...
  evidenceDetailLabel: { width: 72, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  evidenceDetailValue: { flex: 1, color: palette.ricePaper, fontFamily: fontFamilies.data, fontSize: 12, lineHeight: 18 },
  ...
  resultSectionKicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 10, letterSpacing: 1.8 },
  interpretationTitle: { marginTop: spacing.x1, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 21 },
  interpretationVersion: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11 },
  ...
  strengthStatusText: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 21 },
  strengthConfidence: { marginTop: 2, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11 },
  strengthOverviewCopy: { flex: 1 },
  strengthOverviewTitle: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 14, fontWeight: '600' },
  strengthOverviewText: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  structureTagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.x2, marginTop: spacing.x3 },
  structureTag: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12, borderWidth: 1, borderColor: palette.hairlineStrong, borderRadius: radii.pill, paddingHorizontal: spacing.x3, paddingVertical: spacing.x2 },
  ...
  interpretationCardTitle: { color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 17 },
  confidenceChip: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11, borderWidth: 1, borderColor: palette.patina, borderRadius: radii.pill, paddingHorizontal: spacing.x2, paddingVertical: 2 },
  interpretationConclusion: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  interpretationToggle: { flexShrink: 0, color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  emptyEvidenceText: { paddingVertical: spacing.x3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  ...
  evidenceReferenceType: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11 },
  evidenceReferenceCounter: { color: '#D88978' },
  evidenceReferenceLabel: { flex: 1, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 18 },
  evidenceReferenceAction: { minHeight: layout.minTouch, justifyContent: 'center', paddingHorizontal: spacing.x2 },
  evidenceReferenceActionText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 11 },
  ...
  rawEvidenceId: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 10, lineHeight: 15 },
  rawEvidenceFacts: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11, lineHeight: 17 },
  rawEvidenceRule: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 16 },
  interpretationCaveat: { marginTop: spacing.x2, color: '#C5A878', fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 19 },
  tagWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.x2, marginTop: spacing.x3 },
  evidenceTag: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12, borderWidth: 1, borderColor: palette.hairline, borderRadius: radii.pill, paddingHorizontal: spacing.x3, paddingVertical: spacing.x2 },
  focusList: { marginTop: spacing.x6 },
  resultSectionTitle: { marginTop: spacing.x5, marginBottom: spacing.x3, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 19, letterSpacing: 1 },
  ...
  focusIndex: { width: 24, color: palette.brass, fontFamily: fontFamilies.data, fontSize: 12 },
  focusText: { flex: 1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22 },
  ...
  caveatTitle: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13, fontWeight: '600' },
  caveatText: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  hexagramMeta: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  questionEcho: { marginTop: spacing.x4, color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 16, lineHeight: 25, textAlign: 'center' },
  ...
  yaoPosition: { width: 14, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 12 },
  yaoMark: { width: 82 },
  ...
  yaoChange: { width: 22, color: palette.brass, fontFamily: fontFamilies.body, fontSize: 12 },
  yaoCopy: { flex: 1, minWidth: 0 },
  yaoPrimary: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13 },
  yaoSecondary: { marginTop: 3, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 16 },
  ...
  timeText: { color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 12, lineHeight: 19 },
  ...
  ziweiMetaValue: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 15 },
  ...
  palaceName: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 17 },
  palaceBranch: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 11 },
  palaceStars: { marginTop: spacing.x3, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  palaceMinor: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11, lineHeight: 17 },
  palaceDecade: { marginTop: 'auto', color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11 },
  ...
  palaceReading: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  mutagenTag: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12, borderWidth: 1, borderColor: palette.hairlineStrong, borderRadius: radii.pill, paddingHorizontal: spacing.x3, paddingVertical: spacing.x2 },
  ...
  astroCenterMeta: { marginTop: spacing.x1, color: palette.brass, fontFamily: fontFamilies.body, fontSize: 11, letterSpacing: 1.5 },
  ...
  planetPointText: { color: '#C8CAE1', fontFamily: fontFamilies.display, fontSize: 13 },
  ...
  anchorLabel: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13 },
  anchorValue: { color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 16 },
  modeTag: { alignSelf: 'flex-start', marginTop: spacing.x3, color: palette.patina, fontFamily: fontFamilies.body, fontSize: 12, borderWidth: 1, borderColor: palette.patina, borderRadius: radii.pill, paddingHorizontal: spacing.x3, paddingVertical: spacing.x1 },
  ...
  factorName: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13 },
  factorValue: { flex: 1, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 12, textAlign: 'right' },
  ...
  aspectBodies: { color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 13 },
  aspectType: { color: '#B5B7D0', fontFamily: fontFamilies.data, fontSize: 12 },
  ...
  aspectToggleText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12 },
