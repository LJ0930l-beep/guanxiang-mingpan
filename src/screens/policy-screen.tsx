...
const styles = StyleSheet.create({
  ...
  backText: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 16 },
  ...
  eyebrow: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 12, letterSpacing: 3, textAlign: 'center' },
  ...
  updatedAt: { marginTop: spacing.x2, color: palette.patina, fontFamily: fontFamilies.data, fontSize: 13, textAlign: 'center' },
  intro: { marginTop: spacing.x6, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 17, lineHeight: 27 },
  section: { marginTop: spacing.x6, borderTopWidth: 1, borderColor: palette.hairline, paddingTop: spacing.x4 },
  sectionHeading: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 19 },
  sectionBody: { marginTop: spacing.x2, color: palette.ricePaper, fontFamily: fontFamilies.body, fontSize: 16, lineHeight: 26 },
  ...
  footerTitle: { color: '#E4A89A', fontFamily: fontFamilies.display, fontSize: 17 },
  footerBody: { marginTop: spacing.x2, color: '#D0B7AA', fontFamily: fontFamilies.body, fontSize: 14, lineHeight: 22 },
