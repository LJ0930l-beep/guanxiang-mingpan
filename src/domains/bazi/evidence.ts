  ...
  return {
    ...
    trueSolarCorrection: trueSolarResolution?.applied
      ? {
          ...
          algorithmVersion: trueSolarResolution.algorithmVersion,
          ...
          rawCorrectionMinutes: trueSolarResolution.rawCorrectionMinutes,
          correctionMinutes: trueSolarResolution.correctionMinutes,
          appliedCorrectionMinutes: trueSolarResolution.appliedCorrectionMinutes,
          roundingRule: trueSolarResolution.roundingRule,
          dataSource: trueSolarResolution.dataSource,
          dataVersion: trueSolarResolution.dataVersion,
          ...(trueSolarResolution.dataSourceUrl ? { dataSourceUrl: trueSolarResolution.dataSourceUrl } : {}),
          provenanceStatus: trueSolarResolution.provenanceStatus,
      ...
      : {
          ...
          dataVersion: settings.trueSolarTimeVersion,
