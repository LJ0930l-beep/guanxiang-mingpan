...
const styles = StyleSheet.create({
  ...
  title: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 17, textAlign: 'center' },
  body: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 15, lineHeight: 23, textAlign: 'center' },
  ...
  linkText: { color: palette.brass, fontFamily: fontFamilies.body, fontSize: 15, textDecorationLine: 'underline' },
  disclaimer: { marginTop: spacing.x2, color: '#718078', fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20, textAlign: 'center' },
  pressed: { opacity: 0.7 },
});
