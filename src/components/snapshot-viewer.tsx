...
const styles = StyleSheet.create({
  ...
  sectionLabel: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 16, letterSpacing: 0.4 },
  row: { flexDirection: 'row', gap: spacing.x3, marginTop: spacing.x2 },
  rowLabel: { width: 76, color: palette.patina, fontFamily: fontFamilies.body, fontSize: 12 },
  rowValue: { flex: 1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 19 },
  subsection: { marginTop: spacing.x3, borderTopWidth: 1, borderColor: palette.hairline, paddingTop: spacing.x2 },
  subsectionLabel: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 12 },
  versionStrip: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.x2, marginTop: spacing.x3 },
  versionText: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11 },
  observation: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  deepResult: { marginTop: spacing.x3, borderLeftWidth: 2, borderLeftColor: palette.brass, paddingLeft: spacing.x3 },
  deepTitle: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 13 },
  deepConclusion: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  deepRefs: { marginTop: spacing.x1, color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11 },
  missing: { marginTop: spacing.x2, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 20 },
  ...
  diffButtonText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12 },
  diffBox: { marginTop: spacing.x3, borderLeftWidth: 2, borderLeftColor: palette.brass, paddingLeft: spacing.x3 },
  diffTitle: { color: palette.paleBrass, fontFamily: fontFamilies.display, fontSize: 15 },
  diffText: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.data, fontSize: 11, lineHeight: 17 },
  ...
  feedbackStatus: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12 },
  feedbackDate: { color: palette.patina, fontFamily: fontFamilies.data, fontSize: 12 },
  feedbackNote: { marginTop: spacing.x1, color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 13, lineHeight: 19 },
  feedbackLink: { marginTop: spacing.x1, color: palette.patina, fontFamily: fontFamilies.data, fontSize: 11, lineHeight: 17 },
