...
const styles = StyleSheet.create({
  ...
  pillarTop: { fontFamily: fontFamilies.display, fontSize: 14 },
  ...
  ziweiCenter: { position: 'absolute', left: '35%', top: '41%', fontFamily: fontFamilies.display, fontSize: 13, letterSpacing: 2 },
