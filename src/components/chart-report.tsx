...
const styles = StyleSheet.create({
  ...
  kicker: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 8, letterSpacing: 2 },
  title: { marginTop: spacing.x1, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 18, lineHeight: 24 },
  ...
  toggleAllText: { color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 11 },
  summary: { marginTop: spacing.x2, color: palette.paleBrass, fontFamily: fontFamilies.body, fontSize: 12, lineHeight: 19 },
  ...
  sectionIndex: { color: palette.brass, fontFamily: fontFamilies.data, fontSize: 10 },
  sectionHeading: { flex: 1, color: palette.ricePaper, fontFamily: fontFamilies.display, fontSize: 14 },
  ...
  paragraph: { color: palette.ashGreen, fontFamily: fontFamilies.body, fontSize: 11.5, lineHeight: 20 },
