...
const expectedRoutes = ['index.html', 'home.html', 'profiles.html', 'records.html', 'settings.html', '+not-found.html', '_sitemap.html', 'module/[slug].html'];
...
if (!html.includes('观象') || !html.includes('_expo/static/js/web/')) {
